...
def reconnect():
    ...
    print("RUBIKA CONNECTION RESTARTED")
...
def watchdog():
    ...
    while True:
        ...
        if time.time()-started>=RESTART_AFTER:
            restart_bot()
...
# ============================================
# ری‌استارت اتصال روبیکا هر 10 دقیقه
# ============================================

RECONNECT_INTERVAL=10*60
...
def auto_reconnect():
    ...
    while True:
        ...
        try:
            ...
            print(
                "RESTARTING RUBIKA CONNECTION..."
            )

            reconnect()

            print(
                "RUBIKA CONNECTION RESTARTED"
            )
